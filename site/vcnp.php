...
//$cpf_cnpj = new ValidaCPFCNPJ('1234568910111');
//$cpf_cnpj = new ValidaCPFCNPJ('675.401.298-67');
//$cpf_cnpj = new ValidaCPFCNPJ('000.000.000-00');
//$cpf_cnpj = new ValidaCPFCNPJ('111.111.111-11');
//$cpf_cnpj = new ValidaCPFCNPJ('111.222.333-44');
//$cpf_cnpj = new ValidaCPFCNPJ('123.456.789-10');


 

$cpf_cnpj = new ValidaCPFCNPJ($_POST["cnpj"]);
$formatado = $cpf_cnpj->formata();
$r = ($cpf_cnpj->valida()) ? 'true' : 'false'; // $r is set to 'Yes'
echo $r;
