 ...
 if(isset($_FILES['file']['name'][0]))  
 {
	if(estencao($_FILES['file']['name'][0])  &&
      ...
      {  
		   ...
		   echo  '<div class=col-md-3 classRemoveItem '.$newname.'"><img width="20" height="auto" src="http://www.brfinancial.net/assets/img/ok.png"> <a href="http://www.brfinancial.net/upload/'.$newname.'" target="_blank">'.$values.'</a></div>'; 
      } // End foreach
	} // End If released
 }  //End if isset
